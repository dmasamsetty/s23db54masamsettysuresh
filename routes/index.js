...
router.get('/', function (req, res) {
  res.render('index', { title: 'District App', user: req.user });
  });



router.get('/register', function(req, res) {
  res.render('register', { title: 'District App Registration' });
});
...
router.post('/register', function(req, res) {
  ...
  router.get('/login', function(req, res) {
    res.render('login', { title: 'District App Login', user : req.user });
    });
